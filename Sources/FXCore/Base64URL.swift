...
// Vendored from `TSCBasic.Base64URL` (apple/swift-tools-support-core), which was removed
...
extension Array where Element == UInt8 {
    ...
    public init?(base64URL str: String, prepending: [UInt8] = []) {
        guard let array = [UInt8](base64URL: str[str.startIndex...], prepending: prepending) else {
            return nil
        }
        self = array
    }
