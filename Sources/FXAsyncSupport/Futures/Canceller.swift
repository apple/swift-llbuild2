...
package protocol LLBCancelProtocol {
...
package final class LLBCanceller {
    ...
    package init(_ cancelHandler: LLBCancelProtocol? = nil) {
    ...
    package var cancelReason: String? {
        mutex_.lock()
    ...
    package func set(handler newHandler: LLBCancelProtocol?) {
        mutex_.lock()
    ...
    package func cancel(reason specifiedReason: String? = nil) {
        mutex_.lock()
...
package final class LLBCancelHandlersChain: LLBCancelProtocol {
    private let lock = NIOConcurrencyHelpers.NIOLock()
    private var head: LLBCancelProtocol?
    private var tail: LLBCancelProtocol?

    package init(_ first: LLBCancelProtocol? = nil, _ second: LLBCancelProtocol? = nil) {
        self.head = first
        self.tail = second
    }

    /// Add another handler to the chain.
    package func add(handler: LLBCancelProtocol, for canceller: LLBCanceller) {
        lock.withLockVoid {
