...
package struct PSProcessUnknownError: Error & CustomStringConvertible {
    var reason: String
...
package final class PSProcess: Sendable {
    ...
    package var terminationStatus: CInt {
        return self.state.withLockedValue { state in
    ...
    package var currentDirectoryURL: URL? {
        get {
            self.state.withLockedValue { state in
    ...
    package var standardOutput: FileHandle? {
        get {
            self.state.withLockedValue { state in
    ...
    package var standardError: FileHandle? {
        get {
            self.state.withLockedValue { state in
    ...
    package var standardInput: Pipe? {
        get {
            self.state.withLockedValue { state in
    ...
    package var terminationHandler: (@Sendable (PSProcess) -> Void)? {
        get {
            self.state.withLockedValue { state in
    ...
    package var _closeOtherFileDescriptors: Bool {
        get {
            self.state.withLockedValue { state in
    ...
    package var _createNewSession: Bool {
        get {
            self.state.withLockedValue { state in
