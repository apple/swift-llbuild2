...
/// Required for methods that return `google.longrunning.Operation`; invalid
/// otherwise.
let Google_Longrunning_Extensions_operation_info = SwiftProtobuf.MessageExtension<SwiftProtobuf.OptionalMessageExtensionField<Google_Longrunning_OperationInfo>, SwiftProtobuf.Google_Protobuf_MethodOptions>(
...
extension Google_Longrunning_OperationInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularStringField(value: &self.responseType)
      case 2: try decoder.decodeSingularStringField(value: &self.metadataType)
      default: break
      }
    }
  }
