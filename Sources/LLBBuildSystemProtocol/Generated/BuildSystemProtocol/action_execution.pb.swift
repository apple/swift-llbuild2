...
public struct LLBActionInput {
  ...
  public var dataID: LLBPBDataID {
    get {return _dataID ?? LLBPBDataID()}
  ...
  fileprivate var _dataID: LLBPBDataID? = nil
}
...
public struct LLBActionExecutionResponse {
  ...
  public var stderrID: LLBPBDataID {
    get {return _stderrID ?? LLBPBDataID()}
  ...
  fileprivate var _stdoutID: LLBPBDataID? = nil
  fileprivate var _stderrID: LLBPBDataID? = nil
}
