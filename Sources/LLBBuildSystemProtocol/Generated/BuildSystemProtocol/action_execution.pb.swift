...
// Source: BuildSystemProtocol/action_execution.proto
//
...
public struct LLBActionExecutionResponse {
  ...
  public var outputs: [LLBCASProtocol.LLBPBDataID] = []

  //// The exit code for the action execution.
  public var exitCode: Int32 = 0

  //// The dataID for the contents of the stdout of the action.
  public var stdoutID: LLBCASProtocol.LLBPBDataID {
    get {return _stdoutID ?? LLBCASProtocol.LLBPBDataID()}
  ...
  public var stderrID: LLBCASProtocol.LLBPBDataID {
    get {return _stderrID ?? LLBCASProtocol.LLBPBDataID()}
  ...
  fileprivate var _stdoutID: LLBCASProtocol.LLBPBDataID? = nil
  fileprivate var _stderrID: LLBCASProtocol.LLBPBDataID? = nil
}
...
extension LLBActionInput: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try decoder.decodeSingularMessageField(value: &self._dataID)
...
extension LLBActionSpec: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try decoder.decodeRepeatedMessageField(value: &self.environment)
      case 3: try decoder.decodeSingularStringField(value: &self.workingDirectory)
      case 4: try decoder.decodeRepeatedMessageField(value: &self.preActions)
      default: break
      }
    }
  }
...
extension LLBPreActionSpec: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 1: try decoder.decodeRepeatedStringField(value: &self.arguments)
      case 2: try decoder.decodeRepeatedMessageField(value: &self.environment)
      case 3: try decoder.decodeSingularBoolField(value: &self.background)
      default: break
      }
    }
  }
